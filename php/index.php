      ...
      <div class="container py-5 h-100">
        <div class="row d-flex align-items-center justify-content-center h-100">
          ...
          <div class="col-md-8 col-lg-7   col-xl-6 ">
            <img src="../img/Home.svg" class="img-fluid" alt="Phone image">
          </div>

          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">

            <h1>Mycontact</h1>
            <p>We offer you the service of managing your contacts. Register immediately and get
              Unlimited storage space and protection for your personal data with the ability to
               access your account and modify your data and delete it at any time</p>
